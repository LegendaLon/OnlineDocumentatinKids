let BlockData = {
  ...
  "mathoperators": [
...

    {
      ...
      description: 'В першу комірку(value) вказуєте дані яку будуть перетворюватись. В другу та третю (from) ви вказуєте з якого діапазону перетворювати. В четверту та п\'яту (to) ви вказуєте в який діапазон перетворити.',
      alert: [
  ...
  "generichardware": [
...

    {
      ...
      description: 'В першу комірку потрібно вказати пін, в який я підключив trig з датчика. В другу комірку вказуємо пін, в який підключено echo.',
      alert: [
