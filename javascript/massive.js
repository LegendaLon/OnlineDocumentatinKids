  ...
  "generichardware": [
    {
      ...
      image: 'servo.png',
      text: 'Блок для керуванням серво мотора.',
      description: 'В першу комірку вказуємо пін, в який підключено серво мотор. В другу комірку - число(кут) від 0 до 180, на який потрібно повернути серво мотор.',
      alert: [
        'СЕРВО МОТОР НЕ МОЖНА КРУТИТИ РУКАМИ',
        "Якщо ви працюєте з Leo6, не можна виставляти кут серво мотора менше 30 та більше 150. В Leo6 серво мотор підключений до 11 піна(потрібно вказати 11 в першій комірці)",
      ],
    },
  ]
}