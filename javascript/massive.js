let BlockData = {
  "program": [
...

    {
      ...
      description: "При підкріпленні блоків до комірки commands, буде виконувати підкріплені блоки при використанні блока нижче.",
      alert: [
  ...
  'pins':[
    ...
    {
      title: 'Отримання стану аналогово піна',
    ...
    {
      title: 'Отримання стану піна цифрового піна',
...

    {
      ...
      text: 'Блок для зміни значення на піні.',
